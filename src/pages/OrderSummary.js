    ...
    <>
      {orders.length < 1 ? (
        <div className="lg:w-[75%] mx-auto h-screen py-5 md:py-8">
          ...
          <div>
            <img src={NoOrder} alt="noOrder" className="h-[90vh] bg" />
          </div>
        </div>
      ) : (
              ...
              <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                ...
                <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6   ">
                    ...
                    <div className="flex justify-center items-center space-x-4">
                      ...
                      <div className="flex flex-col justify-start items-center">
                        <p className="text-lg leading-6 font-semibold text-gray-800">
                          ...
                          <div className="opacity-60 pt-3 text-md "> CLick Below to Go DPD Official Webside</div>
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="w-full flex justify-center items-center">
                       <button className="hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-5 w-96 md:w-full bg-gray-800 text-base font-medium leading-4 text-white" onClick={event =>  window.location.href='https://www.dpd.com/nl/en/receiving/track/'}>
